...
const getH2ProdDatabaseData = (databaseType, { extraOptions = '' }, { prodDatabaseType, buildDirectory, itests, localDirectory }) => {
  const data = {};
...
const databaseData = {
  ...
  [H2_DISK]: {
    ...
    getData: options => getH2ProdDatabaseData(H2_DISK, { extraOptions: ';DB_CLOSE_DELAY=-1' }, options),
    r2dbc: {
      protocolSuffix: 'h2:file://',
    },
  },
  [H2_MEMORY]: {
    ...
    getData: options => getH2ProdDatabaseData(H2_MEMORY, { extraOptions: ';DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE' }, options),
    r2dbc: {
      protocolSuffix: 'h2:mem:///',
    },
  },
