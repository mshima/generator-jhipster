...
function cleanupOldFiles(generator) {
  ...
  if (generator.isJhipsterVersionLessThan('7.0.0-beta.2') && generator.jhipsterConfig) {
    if (generator.jhipsterConfig.clientFramework === ANGULAR) {
      generator.removeFile(`${ANGULAR_DIR}login/login.model.ts`);
      generator.removeFile(`${ANGULAR_DIR}login/logout.model.ts`);
      generator.removeFile(`${ANGULAR_DIR}login/login.service.ts`);
    }
  }
}
