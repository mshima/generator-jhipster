...
class BusinessErrorChecker {
    ...
    checkForRelationshipErrors() {
        ...
        const skippedUserManagement =
            this.applicationSettings.skippedUserManagement || this.jdlObject.getApplications().some(jdlApplication => jdlApplication.getConfigurationOptionValue(OptionNames.SKIP_USER_MANAGEMENT));
