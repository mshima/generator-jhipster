...
const LOCAL_VERSION_MESSAGE = "Switching to JHipster version installed locally in current project's node_modules";
...
const preferGlobalArg = process.argv.includes('--prefer-global') || process.argv.includes('--prefer-bundled');
